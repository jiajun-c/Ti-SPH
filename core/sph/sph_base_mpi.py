import taichi as ti
import numpy as np
from core.particle_system.particle_system_mpi_v2 import ParticleSystemMPI
import core.const
...
class SPHBaseMPI:
    ...
    def __init__(self, particle_system: ParticleSystemMPI):
    ...
    def enforce_boundary_3D(self):
        for p_i in range(self.ps.left_ghost_num,  self.ps.particle_num[None] - self.ps.right_ghost_num):
    ...
    def enforce_boundary_3D_v1(self, particle_type:int):
        for p_i in range(self.ps.left_ghost_num, self.ps.particle_num - self.ps.right_ghost_num):
